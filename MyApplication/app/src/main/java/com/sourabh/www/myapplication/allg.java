...
public class allg extends Fragment {
    ...
    public  static List<String> comp,status,id;
    ListView gd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        id=new ArrayList<>();
        new allg.logn().execute(String.valueOf(constants.zone));
        return  rootView;
    }
    private class logn extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!result.equalsIgnoreCase("false") &&!result.equalsIgnoreCase("exception")&& ! result.equalsIgnoreCase("unsuccessful")) {
                ...
                try {
                    ...
                    CustomGridAdapter2 adapter=new CustomGridAdapter2(getActivity(),comp,status,id);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://192.168.43.139/allg2.php");
